            ...
            <div className="container">
                <div className="row">
                    <div className="col">
                        ...
                        <p className="py-5 fs-5 lh-lg">Me apasionan la programación y el diseño de páginas web, y poseo las aptitudes y
                    ...
                    <div className="col">
                        <h2 className="fst-italic text-primary">Intereses</h2>
                        <p className="text-primary">EN MIS RATOS LIBRES</p>
